...
class MarketingStrategy
{
    ...
    const SITUATIONS = [
        ...
        2 => [
            'name' => 'Big bang',
            'description' => "The business is new with no or less consumer-base and producer-base. To attract users inject a lot of money to always come first in front of audience. 
